...
public static int diagonalDown(String arr1[], String arr2[], String arr3[], String arr4[]){
	int total=0;
	int top=0;
	for(int x=0;x<=16;x++){
		total=(Integer.parseInt(arr1[x])*Integer.parseInt(arr2[x+1])*Integer.parseInt(arr3[x+2])*Integer.parseInt(arr4[x+3]));
		if(total>=top){
			top=total;
		}
	}
...
public static int diagonalUp(String arr1[], String arr2[], String arr3[], String arr4[]){
	int total=0;
	int top=0;
	for(int x=4;x<=19;x++){
		total=(Integer.parseInt(arr1[x])*Integer.parseInt(arr2[x-1])*Integer.parseInt(arr3[x-2])*Integer.parseInt(arr4[x-3]));
...
public static void main (String[] args) throws java.lang.Exception{
	String row01[]="08 02 22 97 38 15 00 40 00 75 04 05 07 78 52 12 50 77 91 08".split(" ");
	String row02[]="49 49 99 40 17 81 18 57 60 87 17 40 98 43 69 48 04 56 62 00".split(" ");
	String row03[]="81 49 31 73 55 79 14 29 93 71 40 67 53 88 30 03 49 13 36 65".split(" ");
	...
	String row13[]="86 56 00 48 35 71 89 07 05 44 44 37 44 60 21 58 51 54 17 58".split(" ");//Diagonal:70600674
	String row14[]="19 80 81 68 05 94 47 69 28 73 92 13 86 52 17 77 04 89 55 40".split(" ");
	String row15[]="04 52 08 83 97 35 99 16 07 97 57 32 16 26 26 79 33 27 98 66".split(" ");
	String row16[]="88 36 68 87 57 62 20 72 03 46 33 67 46 55 12 32 63 93 53 69".split(" ");
	String row17[]="04 42 16 73 38 25 39 11 24 94 72 18 08 46 29 32 40 62 76 36".split(" ");
